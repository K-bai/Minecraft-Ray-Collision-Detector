...
execute if block ~ ~ ~ #wrnmd:fence_gate_like[facing=north] run function wrnmd:generic/cube/main
execute if block ~ ~ ~ #wrnmd:fence_gate_like[facing=south] run function wrnmd:generic/cube/main
...
execute if block ~ ~ ~ #wrnmd:fence_gate_like[facing=east] run function wrnmd:generic/cube/main
execute if block ~ ~ ~ #wrnmd:fence_gate_like[facing=west] run function wrnmd:generic/cube/main
