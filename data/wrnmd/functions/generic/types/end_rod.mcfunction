...
execute if block ~ ~ ~ minecraft:end_rod[facing=up] run function wrnmd:generic/cube/main
execute if block ~ ~ ~ minecraft:end_rod[facing=down] run function wrnmd:generic/cube/main
...
scoreboard players set #box_z1 wrnmd_system 625
execute if block ~ ~ ~ minecraft:end_rod[facing=east] run function wrnmd:generic/cube/main
execute if block ~ ~ ~ minecraft:end_rod[facing=west] run function wrnmd:generic/cube/main
...
execute if block ~ ~ ~ minecraft:end_rod[facing=north] run function wrnmd:generic/cube/main
execute if block ~ ~ ~ minecraft:end_rod[facing=south] run function wrnmd:generic/cube/main
