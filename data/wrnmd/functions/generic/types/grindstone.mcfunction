...
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=south] run function wrnmd:generic/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=north] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_y0 wrnmd_system 250
scoreboard players set #box_y1 wrnmd_system 1000
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=east] run function wrnmd:generic/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=west] run function wrnmd:generic/complex_cube/main
scoreboard players set #box_x0 wrnmd_system 250
scoreboard players set #box_x1 wrnmd_system 750
...
scoreboard players set #box_z0 wrnmd_system 125
scoreboard players set #box_z1 wrnmd_system 875
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=south] run function wrnmd:generic/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=north] run function wrnmd:generic/complex_cube/main
scoreboard players set #box_x0 wrnmd_system 125
scoreboard players set #box_x1 wrnmd_system 875
scoreboard players set #box_z0 wrnmd_system 250
scoreboard players set #box_z1 wrnmd_system 750
scoreboard players set #box_y0 wrnmd_system 0
scoreboard players set #box_y1 wrnmd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=east] run function wrnmd:generic/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=west] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_x0 wrnmd_system 125
scoreboard players set #box_x1 wrnmd_system 250
scoreboard players set #box_y0 wrnmd_system 563
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z0 wrnmd_system 375
scoreboard players set #box_z1 wrnmd_system 625
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=south] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_z1 wrnmd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=north] run function wrnmd:generic/complex_cube/main
scoreboard players set #box_x0 wrnmd_system 250
scoreboard players set #box_x1 wrnmd_system 750
scoreboard players set #box_y0 wrnmd_system 125
scoreboard players set #box_y1 wrnmd_system 875
...
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=south] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_z0 wrnmd_system 250
scoreboard players set #box_z1 wrnmd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=west] run function wrnmd:generic/complex_cube/main
scoreboard players set #box_x0 wrnmd_system 250
...
scoreboard players set #box_z0 wrnmd_system 250
scoreboard players set #box_z1 wrnmd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=east] run function wrnmd:generic/complex_cube/main
## 两侧爪爪
scoreboard players set #box_x0 wrnmd_system 125
scoreboard players set #box_x1 wrnmd_system 250
scoreboard players set #box_y0 wrnmd_system 313
scoreboard players set #box_y1 wrnmd_system 688
