...
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z1 wrnmd_system 563
execute if block ~ ~ ~ #wrnmd:glass_pane_like[east=true] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z1 wrnmd_system 563
execute if block ~ ~ ~ #wrnmd:glass_pane_like[west=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #wrnmd:glass_pane_like[north=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #wrnmd:glass_pane_like[south=true] run function wrnmd:generic/complex_cube/main
