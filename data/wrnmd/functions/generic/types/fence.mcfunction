...
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z1 wrnmd_system 625
execute if block ~ ~ ~ #minecraft:fences[east=true] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z1 wrnmd_system 625
execute if block ~ ~ ~ #minecraft:fences[west=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:fences[north=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:fences[south=true] run function wrnmd:generic/complex_cube/main
