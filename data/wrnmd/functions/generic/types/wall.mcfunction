...
execute if block ~ ~ ~ #minecraft:walls[up=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[east=true] run function wrnmd:generic/complex_cube/main
...
scoreboard players set #box_y1 wrnmd_system 875
scoreboard players set #box_z1 wrnmd_system 687
execute if block ~ ~ ~ #minecraft:walls[west=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[north=true] run function wrnmd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[south=true] run function wrnmd:generic/complex_cube/main
