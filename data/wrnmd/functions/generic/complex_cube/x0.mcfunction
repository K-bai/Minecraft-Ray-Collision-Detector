...
execute if score #target_y wrnmd_system >= #box_y0 wrnmd_system if score #target_y wrnmd_system <= #box_y1 wrnmd_system if score #target_z wrnmd_system >= #box_z0 wrnmd_system if score #target_z wrnmd_system <= #box_z1 wrnmd_system run summon area_effect_cloud ~ ~ ~ {Duration:999,Tags:["wrnmd_touch_mark","wrnmd_touch_cube_edge","wrnmd_touch_mark_new","wrnmd_touch_x_minus"]}
