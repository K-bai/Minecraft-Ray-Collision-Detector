...
execute if block ~ ~ ~ #minecraft:slabs[type=top] run function wrnmd:block/cube/main
...
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #minecraft:slabs[type=bottom] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 1000
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #minecraft:slabs[type=double] run function wrnmd:block/cube/main