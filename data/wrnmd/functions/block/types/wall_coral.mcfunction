...
execute if block ~ ~ ~ #wrnmd:wall_coral_like[facing=south] run function wrnmd:block/cube/main
...
execute if block ~ ~ ~ #wrnmd:wall_coral_like[facing=north] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 750
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #wrnmd:wall_coral_like[facing=east] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 750
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #wrnmd:wall_coral_like[facing=west] run function wrnmd:block/cube/main