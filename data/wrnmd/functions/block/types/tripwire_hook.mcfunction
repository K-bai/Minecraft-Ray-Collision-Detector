...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=south] run function wrnmd:block/cube/main
...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=north] run function wrnmd:block/cube/main
...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=east] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 625
scoreboard players set #box_z1 wrnmd_system 687
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=west] run function wrnmd:block/cube/main