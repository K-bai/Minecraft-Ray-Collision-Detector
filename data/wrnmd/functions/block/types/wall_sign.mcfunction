...
execute if block ~ ~ ~ #minecraft:wall_signs[facing=south] run function wrnmd:block/cube/main
...
execute if block ~ ~ ~ #minecraft:wall_signs[facing=north] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 781
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #minecraft:wall_signs[facing=east] run function wrnmd:block/cube/main
...
scoreboard players set #box_y1 wrnmd_system 781
scoreboard players set #box_z1 wrnmd_system 1000
execute if block ~ ~ ~ #minecraft:wall_signs[facing=west] run function wrnmd:block/cube/main