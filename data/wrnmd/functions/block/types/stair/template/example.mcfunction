...
# -y
execute if score @s[tag=!wrnmd_touch_edge] wrnmd_y0 matches ..-1 run function wrnmd:block/types/stair/template/y1
...
tag @s[tag=wrnmd_touch_x_minus] add wrnmd_touch_edge
# -x05
execute if score @s[tag=!wrnmd_touch_edge] wrnmd_x0 matches ..-1 run function wrnmd:block/types/stair/template/x05
...
tag @s[tag=wrnmd_touch_y_minus] add wrnmd_touch_edge
# -y05
execute if score @s[tag=!wrnmd_touch_edge] wrnmd_y0 matches ..-1 run function wrnmd:block/types/stair/template/y05
...
tag @s[tag=wrnmd_touch_z_minus] add wrnmd_touch_edge
# -z05
execute if score @s[tag=!wrnmd_touch_edge] wrnmd_z0 matches ..-1 run function wrnmd:block/types/stair/template/z05
