...
# Plane equation: z = #target_z = 0 or 1000
...
# x
scoreboard players operation #target_x mrcd_system = #target_z mrcd_system
...
# y
scoreboard players operation #target_y mrcd_system = #target_z mrcd_system
