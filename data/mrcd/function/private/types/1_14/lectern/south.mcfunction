...
scoreboard players set #box_z1 mrcd_system 391
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z0 mrcd_system 391
scoreboard players set #box_z1 mrcd_system 657
function mrcd:private/complex_cube/main
...
scoreboard players set #box_z0 mrcd_system 657
