...
scoreboard players set #box_z0 mrcd_system 609
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z0 mrcd_system 343
scoreboard players set #box_z1 mrcd_system 609
function mrcd:private/complex_cube/main
...
scoreboard players set #box_z0 mrcd_system 62
scoreboard players set #box_z1 mrcd_system 343
function mrcd:private/complex_cube/main