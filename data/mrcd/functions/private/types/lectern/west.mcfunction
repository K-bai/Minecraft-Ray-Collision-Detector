# top block
scoreboard players set #box_x0 mrcd_system 609
...
# mid block
scoreboard players set #box_x0 mrcd_system 343
scoreboard players set #box_x1 mrcd_system 609
...
# bottom block
scoreboard players set #box_x0 mrcd_system 62
scoreboard players set #box_x1 mrcd_system 343
