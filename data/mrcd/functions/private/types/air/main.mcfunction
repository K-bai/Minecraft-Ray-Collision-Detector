...
execute if score @s[tag=!mrcd_touch_edge_air] mrcd_y0 matches ..-1 run function mrcd:private/types/air/y_minus
execute if score @s[tag=!mrcd_touch_edge_air] mrcd_z0 matches 1.. run function mrcd:private/types/air/z_plus
execute if score @s[tag=!mrcd_touch_edge_air] mrcd_z0 matches ..-1 run function mrcd:private/types/air/z_minus