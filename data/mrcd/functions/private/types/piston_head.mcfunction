...
execute if block ~ ~ ~ minecraft:piston_head[facing=north] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:piston_head[facing=south] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_y0 mrcd_system 375
scoreboard players set #box_z0 mrcd_system 0
scoreboard players set #box_x1 mrcd_system 625
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:piston_head[facing=west] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:piston_head[facing=east] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 0
scoreboard players set #box_y0 mrcd_system 375
scoreboard players set #box_z0 mrcd_system 375
...
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:piston_head[facing=down] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 375
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:piston_head[facing=up] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_y0 mrcd_system 0
scoreboard players set #box_z0 mrcd_system 375
scoreboard players set #box_x1 mrcd_system 625
