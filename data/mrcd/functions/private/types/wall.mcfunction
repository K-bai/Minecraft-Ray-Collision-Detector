...
execute if block ~ ~ ~ #minecraft:walls[up=true] run function mrcd:private/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[east=low] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 875
scoreboard players set #box_z1 mrcd_system 687
execute if block ~ ~ ~ #minecraft:walls[west=low] run function mrcd:private/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[north=low] run function mrcd:private/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:walls[south=low] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 687
execute if block ~ ~ ~ #minecraft:walls[east=tall] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 687
execute if block ~ ~ ~ #minecraft:walls[west=tall] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 500
execute if block ~ ~ ~ #minecraft:walls[north=tall] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #minecraft:walls[south=tall] run function mrcd:private/complex_cube/main
