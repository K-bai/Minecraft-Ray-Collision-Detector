...
execute if block ~ ~ ~ #mrcd:vine_like[south=true] run function mrcd:private/complex_cube/main
...
execute if block ~ ~ ~ #mrcd:vine_like[north=true] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:vine_like[east=true] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:vine_like[west=true] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:vine_like[up=true] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:vine_like[up=false,west=false,east=false,south=false,north=false] run function mrcd:private/complex_cube/main
