...
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=south] run function mrcd:private/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=north] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_y0 mrcd_system 250
scoreboard players set #box_y1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=east] run function mrcd:private/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=floor,facing=west] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 250
scoreboard players set #box_x1 mrcd_system 750
...
scoreboard players set #box_z0 mrcd_system 125
scoreboard players set #box_z1 mrcd_system 875
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=south] run function mrcd:private/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=north] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 125
scoreboard players set #box_x1 mrcd_system 875
scoreboard players set #box_z0 mrcd_system 250
scoreboard players set #box_z1 mrcd_system 750
scoreboard players set #box_y0 mrcd_system 0
scoreboard players set #box_y1 mrcd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=east] run function mrcd:private/complex_cube/main
execute if block ~ ~ ~ minecraft:grindstone[face=ceiling,facing=west] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_z1 mrcd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=north] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 250
scoreboard players set #box_x1 mrcd_system 750
scoreboard players set #box_y0 mrcd_system 125
scoreboard players set #box_y1 mrcd_system 875
...
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=south] run function mrcd:private/complex_cube/main
...
scoreboard players set #box_z0 mrcd_system 250
scoreboard players set #box_z1 mrcd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=west] run function mrcd:private/complex_cube/main
scoreboard players set #box_x0 mrcd_system 250
...
scoreboard players set #box_z0 mrcd_system 250
scoreboard players set #box_z1 mrcd_system 750
execute if block ~ ~ ~ minecraft:grindstone[face=wall,facing=east] run function mrcd:private/complex_cube/main
## 两侧爪爪
scoreboard players set #box_x0 mrcd_system 125
scoreboard players set #box_x1 mrcd_system 250
