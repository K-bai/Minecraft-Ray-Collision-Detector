...
execute if block ~ ~ ~ #mrcd:wall_torches[facing=south] run function mrcd:private/cube/main
...
execute if block ~ ~ ~ #mrcd:wall_torches[facing=north] run function mrcd:private/cube/main
...
execute if block ~ ~ ~ #mrcd:wall_torches[facing=east] run function mrcd:private/cube/main
...
scoreboard players set #box_y1 mrcd_system 813
scoreboard players set #box_z1 mrcd_system 656
execute if block ~ ~ ~ #mrcd:wall_torches[facing=west] run function mrcd:private/cube/main
