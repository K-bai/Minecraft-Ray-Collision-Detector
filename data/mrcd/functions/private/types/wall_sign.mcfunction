...
execute if block ~ ~ ~ #minecraft:wall_signs[facing=south] run function mrcd:private/cube/main
...
execute if block ~ ~ ~ #minecraft:wall_signs[facing=north] run function mrcd:private/cube/main
...
scoreboard players set #box_y1 mrcd_system 781
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #minecraft:wall_signs[facing=east] run function mrcd:private/cube/main
