...
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=north] run function mrcd:private/cube/main
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=south] run function mrcd:private/cube/main
