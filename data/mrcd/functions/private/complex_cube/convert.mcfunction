...
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_x_plus,limit=1] run tag @s add mrcd_touch_x_plus
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_x_minus,limit=1] run tag @s add mrcd_touch_x_minus
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_y_plus,limit=1] run tag @s add mrcd_touch_y_plus
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_y_minus,limit=1] run tag @s add mrcd_touch_y_minus
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_z_plus,limit=1] run tag @s add mrcd_touch_z_plus
execute if entity @e[tag=mrcd_temp,tag=mrcd_touch_z_minus,limit=1] run tag @s add mrcd_touch_z_minus
