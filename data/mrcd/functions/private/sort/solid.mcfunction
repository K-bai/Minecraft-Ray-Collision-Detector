# Complex blocks
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ scaffolding run function mrcd:private/types/scaffolding
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ piston_head run function mrcd:private/types/piston_head
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ brewing_stand run function mrcd:private/types/brewing_stand
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ grindstone run function mrcd:private/types/grindstone
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ bell run function mrcd:private/types/bell
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ cauldron run function mrcd:private/types/cauldron
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ cocoa run function mrcd:private/types/cocoa
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ daylight_detector run function mrcd:private/types/daylight_detector
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ enchanting_table run function mrcd:private/types/enchanting_table
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ stonecutter run function mrcd:private/types/stonecutter
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ end_portal_frame run function mrcd:private/types/end_portal_frame
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ ladder run function mrcd:private/types/ladder
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ snow run function mrcd:private/types/snow
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ cactus run function mrcd:private/types/cactus
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ cake run function mrcd:private/types/cake
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:campfires run function mrcd:private/types/campfires
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:fence_gate_like run function mrcd:private/types/fence_gate
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:skull_like run function mrcd:private/types/skull
