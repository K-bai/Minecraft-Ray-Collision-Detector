# Complex blocks
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ redstone_wire run function mrcd:private/types/redstone_wire
...
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ kelp run function mrcd:private/types/kelp
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ lever run function mrcd:private/types/lever
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ tripwire_hook run function mrcd:private/types/tripwire_hook
...
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ sweet_berry_bush run function mrcd:private/types/sweet_berry_bush
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ tripwire run function mrcd:private/types/tripwire
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ bamboo_sapling run function mrcd:private/types/bamboo_sapling

execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ #wall_signs run function mrcd:private/types/wall_sign
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ #buttons run function mrcd:private/types/button
...
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ #mrcd:wall_coral_like run function mrcd:private/types/wall_coral
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ #mrcd:coral_plant_like run function mrcd:private/types/coral_plant
execute if entity @s[tag=!mrcd_block_collision_done] if block ~ ~ ~ #mrcd:coral_fan_like run function mrcd:private/types/coral_fan
