...
execute if block ~ ~ ~ minecraft:lectern[facing=north] run function mrcd:generic/complex_cube/main
scoreboard players set #box_x0 mrcd_system 0
scoreboard players set #box_x1 mrcd_system 1000
...
execute if block ~ ~ ~ minecraft:lectern[facing=south] run function mrcd:generic/complex_cube/main
scoreboard players set #box_x0 mrcd_system 0
scoreboard players set #box_x1 mrcd_system 1000
scoreboard players set #box_y0 mrcd_system 729
scoreboard players set #box_y1 mrcd_system 865
...
execute if block ~ ~ ~ minecraft:lectern[facing=west] run function mrcd:generic/complex_cube/main
scoreboard players set #box_z0 mrcd_system 0
scoreboard players set #box_z1 mrcd_system 1000
scoreboard players set #box_y0 mrcd_system 729
scoreboard players set #box_y1 mrcd_system 865
...
execute if block ~ ~ ~ minecraft:lectern[facing=east] run function mrcd:generic/complex_cube/main
scoreboard players set #box_z0 mrcd_system 0
scoreboard players set #box_z1 mrcd_system 1000
scoreboard players set #box_y0 mrcd_system 729
scoreboard players set #box_y1 mrcd_system 865
