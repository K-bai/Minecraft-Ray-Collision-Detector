...
execute if block ~ ~ ~ #mrcd:wall_coral_like[facing=south] run function mrcd:generic/cube/main
...
execute if block ~ ~ ~ #mrcd:wall_coral_like[facing=north] run function mrcd:generic/cube/main
...
scoreboard players set #box_y1 mrcd_system 750
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:wall_coral_like[facing=east] run function mrcd:generic/cube/main
...
scoreboard players set #box_y1 mrcd_system 750
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #mrcd:wall_coral_like[facing=west] run function mrcd:generic/cube/main
