...
execute if block ~ ~ ~ minecraft:hopper[facing=down] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_z0 mrcd_system 375
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ minecraft:hopper[facing=east] run function mrcd:generic/complex_cube/main
scoreboard players set #box_x0 mrcd_system 0
...
scoreboard players set #box_z0 mrcd_system 375
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ minecraft:hopper[facing=west] run function mrcd:generic/complex_cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_x1 mrcd_system 625
scoreboard players set #box_y0 mrcd_system 250
scoreboard players set #box_y1 mrcd_system 500
...
execute if block ~ ~ ~ minecraft:hopper[facing=north] run function mrcd:generic/complex_cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_x1 mrcd_system 625
scoreboard players set #box_y0 mrcd_system 250
scoreboard players set #box_y1 mrcd_system 500
...
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ minecraft:hopper[facing=south] run function mrcd:generic/complex_cube/main
