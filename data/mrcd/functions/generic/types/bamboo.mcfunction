...
function mrcd:generic/calculate/offset
...
execute if block ~ ~ ~ minecraft:bamboo[leaves=large] run function mrcd:generic/cube/main
...
scoreboard players operation #box_z0 mrcd_system += #var1 mrcd_system
scoreboard players operation #box_z1 mrcd_system += #var1 mrcd_system
execute if block ~ ~ ~ minecraft:bamboo[leaves=none] run function mrcd:generic/cube/main
execute if block ~ ~ ~ minecraft:bamboo[leaves=small] run function mrcd:generic/cube/main
