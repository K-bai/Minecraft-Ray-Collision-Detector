...
scoreboard players set #box_y1 mrcd_system 813
scoreboard players set #box_z1 mrcd_system 813
execute if block ~ ~ ~ minecraft:chorus_plant[east=true] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 813
scoreboard players set #box_z1 mrcd_system 813
execute if block ~ ~ ~ minecraft:chorus_plant[west=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ minecraft:chorus_plant[north=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ minecraft:chorus_plant[south=true] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_z1 mrcd_system 813
execute if block ~ ~ ~ minecraft:chorus_plant[up=true] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_z1 mrcd_system 813
execute if block ~ ~ ~ minecraft:chorus_plant[down=true] run function mrcd:generic/complex_cube/main
