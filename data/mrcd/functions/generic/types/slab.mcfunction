...
execute if block ~ ~ ~ #minecraft:slabs[type=top] run function mrcd:generic/cube/main
...
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #minecraft:slabs[type=bottom] run function mrcd:generic/cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 1000
execute if block ~ ~ ~ #minecraft:slabs[type=double] run function mrcd:generic/cube/main
