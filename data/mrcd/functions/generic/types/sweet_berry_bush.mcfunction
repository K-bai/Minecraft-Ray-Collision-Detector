...
execute if block ~ ~ ~ minecraft:sweet_berry_bush[age=0] run function mrcd:generic/cube/main
...
execute if block ~ ~ ~ minecraft:sweet_berry_bush[age=1] run function mrcd:generic/cube/main
execute if block ~ ~ ~ minecraft:sweet_berry_bush[age=2] run function mrcd:generic/cube/main
