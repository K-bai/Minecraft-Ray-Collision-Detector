...
scoreboard players set #box_y1 mrcd_system 812
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=north] run function mrcd:generic/cube/main
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=south] run function mrcd:generic/cube/main
...
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=east] run function mrcd:generic/cube/main
execute if block ~ ~ ~ #mrcd:fence_gate_like[facing=west] run function mrcd:generic/cube/main
