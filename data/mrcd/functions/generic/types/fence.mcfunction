...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ #minecraft:fences[east=true] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ #minecraft:fences[west=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:fences[north=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ #minecraft:fences[south=true] run function mrcd:generic/complex_cube/main
