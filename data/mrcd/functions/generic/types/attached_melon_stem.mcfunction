...
execute if block ~ ~ ~ #mrcd:attached_melon_stem_like[facing=south] run function mrcd:generic/cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_y0 mrcd_system 0
...
execute if block ~ ~ ~ #mrcd:attached_melon_stem_like[facing=north] run function mrcd:generic/cube/main
scoreboard players set #box_x0 mrcd_system 375
scoreboard players set #box_y0 mrcd_system 0
scoreboard players set #box_z0 mrcd_system 375
...
scoreboard players set #box_y1 mrcd_system 625
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ #mrcd:attached_melon_stem_like[facing=east] run function mrcd:generic/cube/main
...
scoreboard players set #box_y1 mrcd_system 625
scoreboard players set #box_z1 mrcd_system 625
execute if block ~ ~ ~ #mrcd:attached_melon_stem_like[facing=west] run function mrcd:generic/cube/main
