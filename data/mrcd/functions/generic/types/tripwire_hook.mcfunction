...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=south] run function mrcd:generic/cube/main
...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=north] run function mrcd:generic/cube/main
...
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=east] run function mrcd:generic/cube/main
...
scoreboard players set #box_y1 mrcd_system 625
scoreboard players set #box_z1 mrcd_system 687
execute if block ~ ~ ~ minecraft:tripwire_hook[facing=west] run function mrcd:generic/cube/main
