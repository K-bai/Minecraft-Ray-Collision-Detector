...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 563
execute if block ~ ~ ~ #mrcd:glass_pane_like[east=true] run function mrcd:generic/complex_cube/main
...
scoreboard players set #box_y1 mrcd_system 1000
scoreboard players set #box_z1 mrcd_system 563
execute if block ~ ~ ~ #mrcd:glass_pane_like[west=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ #mrcd:glass_pane_like[north=true] run function mrcd:generic/complex_cube/main
...
execute if block ~ ~ ~ #mrcd:glass_pane_like[south=true] run function mrcd:generic/complex_cube/main
