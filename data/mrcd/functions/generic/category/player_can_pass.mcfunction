...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:lever run function mrcd:generic/types/lever
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:tripwire_hook run function mrcd:generic/types/tripwire_hook
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:lily_pad run function mrcd:generic/types/lily_pad
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:wheat run function mrcd:generic/types/wheat
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:sugar_cane run function mrcd:generic/types/sugar_cane
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #minecraft:small_flowers run function mrcd:generic/types/flower
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:standing_sign_like run function mrcd:generic/types/standing_sign
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:attached_melon_stem_like run function mrcd:generic/types/attached_melon_stem
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:melon_stem_like run function mrcd:generic/types/melon_stem
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:wall_torch_like run function mrcd:generic/types/wall_torch
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:torch_like run function mrcd:generic/types/torch
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:wall_coral_like run function mrcd:generic/types/wall_coral
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:coral_plant_like run function mrcd:generic/types/coral_plant
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:coral_fan_like run function mrcd:generic/types/coral_fan
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:grass_like run function mrcd:generic/types/grass
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:sapling_like run function mrcd:generic/types/sapling
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:wall_banner_like run function mrcd:generic/types/wall_banner
