...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #mrcd:lanterns run function mrcd:generic/types/lanterns
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ #minecraft:campfires run function mrcd:generic/types/campfires
...
execute if entity @s[tag=!mrcd_detected] if block ~ ~ ~ minecraft:chain run function mrcd:generic/types/chain
