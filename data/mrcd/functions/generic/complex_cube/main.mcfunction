...
execute unless entity @e[tag=mrcd_touch_cube_edge] if score @s mrcd_y0 matches ..-1 if score #block_y mrcd_system >= #box_y1 mrcd_system run function mrcd:generic/complex_cube/y1
execute unless entity @e[tag=mrcd_touch_cube_edge] if score @s mrcd_z0 matches 1.. if score #block_z mrcd_system <= #box_z0 mrcd_system run function mrcd:generic/complex_cube/z0
execute unless entity @e[tag=mrcd_touch_cube_edge] if score @s mrcd_z0 matches ..-1 if score #block_z mrcd_system >= #box_z1 mrcd_system run function mrcd:generic/complex_cube/z1
